    ...
    element: (() => {
        ...
        if (365 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'sân bay quốc tế là một sân bay thường được trang bị các trang thiết bị hải quan và nhập cư để xử lý các chuyến bay quốc tế đến và đi từ các nước khác. Sân bay này thường lớn hơn, và so với sân bay nội địa, sân bay quốc tế thường có đường băng dài hơn và cơ sở vật chất tốt hơn để thích ứng với máy bay lớn thường được sử dụng cho các tuyến quốc tế hoặc liên lục địa';
            }
